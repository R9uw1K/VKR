...
urlpatterns = [
    ...
    path('collection', views.articles, name='articles'),
    ...
    path('normalize/jats/<str:version>/<int:article_id>/', views.jats_export_by_id, name='jats_export_by_id'),
    path('normalize/eudml/<int:article_id>/', views.eudml_export_by_id, name='eudml_export_by_id')
]
